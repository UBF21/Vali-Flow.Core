...
/// <summary>
/// Defines fluent builder methods for constructing Vali-Flow.Core conditions based on <see cref="TimeOnly"/> property evaluations.
/// </summary>
...
public interface ITimeOnlyExpression<out TBuilder, T>
{
    ...
    /// <summary>Validates that the selected <see cref="TimeOnly"/> falls within the inclusive range [<paramref name="from"/>, <paramref name="to"/>].</summary>
    /// <param name="selector">Expression selecting the <see cref="TimeOnly"/> property.</param>
