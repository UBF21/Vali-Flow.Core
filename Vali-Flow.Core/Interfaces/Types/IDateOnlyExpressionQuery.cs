...
public interface IDateOnlyExpressionQuery<out TBuilder, T>
{
    ...
    /// <summary>Validates that the selected <see cref="DateOnly"/> falls within the last <paramref name="days"/> UTC calendar days (today excluded).</summary>
    /// <param name="selector">Expression selecting the <see cref="DateOnly"/> property.</param>
    ...
    /// <summary>Validates that the selected <see cref="DateOnly"/> falls within the next <paramref name="days"/> UTC calendar days (today excluded).</summary>
    /// <param name="selector">Expression selecting the <see cref="DateOnly"/> property.</param>
